...
def run_e2e(symbol: str | None = None, upload: bool = False) -> bool:
    ...
    print(f"  TTS 나레이션      : {'성공' if result.tts_ok else '실패 (영상은 무음으로 생성)'}")
    ...
    if upload:
        ...
        print(f"  YouTube Shorts    : {'업로드 성공' if result.youtube_ok else '미설정/실패'}")
...
if __name__ == "__main__":
    ...
    print(LINE)
    print("Stock Snap — Instagram Reels E2E 테스트 스위트")
    print(LINE)
